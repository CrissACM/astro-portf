  ...
  return (
    ...
    >
      <div className="z-[1] flex h-[60px] w-full max-w-[1200px] items-center justify-between px-6 py-0">
        ...
        >
          <span
            className={`block h-1 w-6 rounded-xs bg-dark transition-all duration-300 ease-out dark:bg-light ${
              isOpen ? "translate-y-1 rotate-45" : "-translate-y-0.5"
            }`}
          />
          <span
            className={`block w-6 rounded-xs bg-dark transition-all duration-300 ease-out dark:bg-light ${
